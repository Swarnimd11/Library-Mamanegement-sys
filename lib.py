...
class menu:
    ...
    def __init__(self):
        ...
        l1=Button(self.a,text='BOOK DATA',font='Times 22 bold',fg='White',bg='Black',width=19,padx=10,borderwidth=10,relief=RAISED,command=self.book).place(x=400,y=400)
        l2=Button(self.a,text='STUDENT DATA',font='Times 22 bold',fg='White',bg='Black',width=19,padx=10,borderwidth=10,relief=RAISED,command=self.student).place(x=800,y=400)
        self.root.mainloop()
    ...
    def book(self):
        ...
        l1=Button(self.a,text='Add Books',font='Times 22 bold',fg='White',bg='Black',width=15,padx=10,command=self.addbook).place(x=12,y=100)
        l2=Button(self.a,text='Search Books',font='Times 22 bold',fg='White',bg='Black',width=15,padx=10,command=self.search).place(x=12,y=200)

        l4=Button(self.a,text='All Books',font='Times 22 bold',fg='White',bg='Black',width=15,padx=10,command=self.all).place(x=12,y=300)
        l4=Button(self.a,text='<< Main Menu',font='Times 22 bold',fg='White',bg='Black',width=15,padx=10,command=self.mainmenu).place(x=12,y=500)
    ...
    def search(self):
        ...
        self.f1=Frame(self.a,height=500,width=650,bg='black')
        self.f1.place(x=500,y=100)
        l1=Label(self.f1,text='Book ID/Title/Author/Genre: ',font=('Times 10 bold'),bd=2, fg='white',bg='black').place(x=20,y=40)
        e1=Entry(self.f1,width=25,bd=5,bg='black',fg='white',textvariable=self.sid).place(x=260,y=40)
        b1=Button(self.f1,text='Search',bg='white',font='Times 10 bold',width=9,bd=2,command=self.serch1).place(x=500,y=37)
        b1=Button(self.f1,text='Back',bg='white',font='Times 10 bold',width=10,bd=2,command=self.rm).place(x=250,y=450)
    ...
    def serch1(self):
        ...
        if k!="":
            ...
            if len(a)!=0:
                ...
                self.cm =ttk.Combobox(self.f1,textvariable=self.variable ,state='readonly',font='Times 15 bold',height=50,width=15,)
    ...
    def combo(self,event):
        ...
        #l7=Label(self.f1,text='copies to update: ',font='Times 10 bold',bd=1).place(x=250,y=700)
    ...
    def deleteitem(self):
        try:
            ...
            b1=Button(self.f1,text='Update',font='Times 10 bold',width=9,bd=3,command=self.delete2).place(x=500,y=97)
    ...
    def copies(self,varr):
        try:
            ...
            if varr==0:
                b5=Button(self.f1,text='Update',font='Times 10 bold',bg='Black',fg='white',width=9,bd=3,command=self.copiesadd).place(x=500,y=97)
            if varr==1:
                b6=Button(self.f1,text='Update',font='Times 10 bold',bg='black',fg='white',width=9,bd=3,command=self.copiesdelete).place(x=500,y=97)
        except:
            messagebox.showinfo("Empty","Please select something.")
    ...
    def all(self):
        self.f1=Frame(self.a,height=500,width=650,bg='black')
        self.f1.place(x=500,y=100)
        b1=Button(self.f1,text='Back',bg='black' ,fg='white',width=10,bd=3,command=self.rm).place(x=250,y=400)
        conn=sqlite3.connect('test.db')
    ...
    def student(self):
        self.a.destroy()
        self.a=self.canvases(image2)
        l1=Button(self.a,text='Issue book',font='Times 22 bold',fg='White',bg='Black',width=15,padx=10,command=self.issue).place(x=12,y=100)
        l2=Button(self.a,text='Return Book',font='Times 22 bold',fg='White',bg='Black',width=15,padx=10,command=self.returnn).place(x=12,y=200)
        l3=Button(self.a,text='Student Activity',font='Times 22 bold',fg='White',bg='Black',width=15,padx=10,command=self.activity).place(x=12,y=300)
        l4=Button(self.a,text='<< Main Menu',font='Times 22 bold',fg='White',bg='Black',width=15,padx=10,command=self.mainmenu).place(x=12,y=600)
    ...
    def issue(self):
        ...
        self.f1.place(x=500,y=100)
        l1=Label(self.f1,text='Book ID : ',font='Times 15 bold',bg='black',fg='white').place(x=50,y=100)
        e1=Entry(self.f1,width=25,bd=4,bg='white',textvariable=self.aidd).place(x=180,y=100)
        l2=Label(self.f1,text='Student Id : ',font='Times 15 bold',bg='black',fg='white').place(x=50,y=150)
        e2=Entry(self.f1,width=25,bd=4,bg='white',textvariable=self.astudentt).place(x=180,y=150)
        b1=Button(self.f1,text='Back',font='Times 10 bold',fg='black',bg='white',width=10,bd=3,command=self.rm).place(x=50,y=250)
        b1=Button(self.f1,text='Issue',font='Times 10 bold',fg='black',bg='white',width=10,bd=3,command=self.issuedbook).place(x=200,y=250)
    ...
    def returnn(self):
        ...
        self.f1=Frame(self.a,height=550,width=500,bg='black')
        self.f1.place(x=500,y=100)
        l1=Label(self.f1,text='Book ID : ',font='Times 15 bold',fg='orange', bg='black').place(x=50,y=100)
        e1=Entry(self.f1,width=25,bd=4,bg='orange',textvariable=self.aidd).place(x=180,y=100)
        l2=Label(self.f1,text='Student Id : ',font='Times 15 bold',fg='orange', bg='black').place(x=50,y=150)
        e2=Entry(self.f1,width=25,bd=4,bg='orange',textvariable=self.astudentt).place(x=180,y=150)
        b1=Button(self.f1,text='Back',font='Times 10 bold',bg='white',fg='black',width=10,bd=3,command=self.rm).place(x=50,y=250)
        b1=Button(self.f1,text='Return',font='Times 10 bold',bg='white',fg='black',width=10,bd=3,command=self.returnbook).place(x=200,y=250)
        self.f1.grid_propagate(0)
    ...
    def activity(self):
        ...
        l1=Label(self.f1,text='Book/Student ID : ',font='Times 15 bold',fg='Orange',bg='black').place(x=50,y=30)
        e1=Entry(self.f1,width=20,bd=4,bg='white',textvariable=self.aidd).place(x=280,y=35)
        #l2=Label(self.f1,text='Student Id : ',font='Times 15 bold',fg='orange',bg='black').place(x=50,y=80)
        #e2=Entry(self.f1,width=20,bd=4,bg='orange',textvariable=self.astudentt).place(x=180,y=80)
        b1=Button(self.f1,text='Back',bg='white',font='Times 10 bold',width=10,bd=3,command=self.rm).place(x=340,y=450)
        b1=Button(self.f1,text='Search',bg='white',font='Times 10 bold',width=10,bd=3,command=self.searchact).place(x=40,y=450)
        b1=Button(self.f1,text='All',bg='white',font='Times 10 bold',width=10,bd=3,command=self.searchall).place(x=190,y=450)
        self.f1.grid_propagate(0)
...
def Database():
    ...
    if cursor.fetchone() is None:
        cursor.execute("INSERT INTO `login` (username, password) VALUES('DBMS', 'root')")
        conn.commit()
...
#==============================FRAMES=========================================
'''Top = Frame(root, bd=2,  relief=FLAT)
Top.pack(side=TOP, fill=X)
Form = Frame(root, height=200)
Form.pack(side=BOTTOM, pady=20)'''
#==============================LABELS=========================================

#lbl_title = Label(canvas, text = "ADMIN   LOGIN", font=('Times', 30,'bold', ),bg='white', fg='Black')
#lbl_title.place(x=600,y=100)
lbl_username = Label(canvas, text = "........ :", font=('Times', 15,'bold'),bd=4, fg='White')
lbl_username.place(x=500,y=230)
lbl_password = Label(canvas, text = "........ :", font=('Times', 15,'bold'),bd=3, fg='White')
...
#==============================BUTTON WIDGETS=================================
btn_login = Button(canvas, text="LOGIN", font=('Helvetica 15 bold'),width=25,command=Login, bg='black', fg='White')
btn_login.place(x=600,y=450)
